  ...
  return (
    <div className={style.logOutPage}>
        <div className={style.logOutContainer}>
            ...
            <span className={style.logOutTitle}>
                X'ten çıkış yapılsın mı?
            </span>
            <span className={style.logOutSubtitle}>
                İstediğin zaman tekrar oturum açabilirsin. Hesap değiştirmek istiyorsan bunu mevcut bir hesabı ekleyerek yapabilirsin. 
            </span>
